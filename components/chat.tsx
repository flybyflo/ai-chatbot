  ...
  return (
    <>
      <div className="flex flex-col min-w-0 h-dvh bg-background">
        ...
        {/* Elicitation fallback is rendered inside message flow in Messages */}
      ...
      {/* Elicitation fallback handled by Messages; overlay removed */}
    </>
  );
}
// Inline fallback previously here is now rendered in Messages component only
