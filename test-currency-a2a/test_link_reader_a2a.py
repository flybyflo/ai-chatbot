#!/usr/bin/env python3
"""Test script for link reader via A2A server."""
...
async def test_link_reader_a2a():
    """Test link reader via A2A server."""
    ...
    async with httpx.AsyncClient() as httpx_client:
        ...
        try:
            ...
            # Test link reader with a simple URL
            test_message = "summarize https://httpbin.org/html"
            logger.info(f"\nTesting link reader: '{test_message}'")
...
if __name__ == "__main__":
    asyncio.run(test_link_reader_a2a())
